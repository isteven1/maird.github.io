...
```{r warning = FALSE, message = FALSE}
#Convert the Column "country" from a factor to a string of characters
gapdata$country <- as.character(gapdata$country) 

#Fix inconsistency for the country Yemen in gapdata
...
#Tidy data for children_per_woman_total_fertility and then join with the other datasets
